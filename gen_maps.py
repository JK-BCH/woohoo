...
put(c,38,28,'H')   # [DEBUG] 정체불명의 돌탑 — 완성본에서 히든 아이템박스로 교체 예정
...
# 보행 포털/도착점/상호작용 지점
CHECK={
 'campus':dict(start=(19,12),walk=[(6,28)],doors=[(19,4),(7,7),(31,7),(29,15),(10,20),(38,28)],npc=[(17,6)],arrive=[(6,27),(7,8),(31,8),(19,5),(19,12),(29,16)]),
